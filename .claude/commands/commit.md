...
2. Generate 2 commit message candidates based on the changes
   ...
   - Commits should have a single sentence subject/header with more description in the commit body
3. Select the most appropriate commit message from the 2 candidates and explain the reasoning for your choice
